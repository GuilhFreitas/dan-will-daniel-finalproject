...
export default function About(props){
    ...
    return(
        ...
        <CardContent>
          ...
          With a sleek and user-friendly design, our app allows you to choose from a range of quizzes covering topics such as history, science, pop culture, and more. You can even create your own quiz and share it with friends!
